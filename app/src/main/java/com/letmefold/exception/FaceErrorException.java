 ...
 */
package com.letmefold.exception;

/**
 * @author baidu
 */
public class FaceErrorException extends Exception {
    ...
    public FaceErrorException(int errorCode, String message, Throwable cause) {
        super(message, cause);
        this.cause = cause;
        this.errorCode = errorCode;
    }

    public FaceErrorException(int errorCode, String message) {
        super(message);
        this.errorCode = errorCode;
        this.errorMessage = message;
    }

    public FaceErrorException(String message) {
        super(message);
    }

    public FaceErrorException() {
